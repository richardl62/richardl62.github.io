...
class GamesBoard {
    ...
    clickSquare(callback) {
        ...
        $(".gamesBoardSquare").click(
            function(){callback(games_board.getSquareFromElem(this, "click"));}
        );
    }

    hoverSquare(in_cb, out_cb) {
        var games_board = this;
   
        var xxx = in_cb;
        $(".gamesBoardSquare").hover(
            function(){in_cb(games_board.getSquareFromElem(this, "hover-in"));},
            function(){out_cb(games_board.getSquareFromElem(this, "hover-out"));},
        );
    }
