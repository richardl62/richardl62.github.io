...
class gamesBoardSquare {
    ...
    status(new_status)
    {
        ...
        else
        {
            ...
            {
                this.elem.addClass("game-board-square-disabled");
            }
            else
            {
                this.elem.removeClass("game-board-square-disabled");
                var counter_color = player ? gamesBoardPlayerColor(player) : "inherit";
